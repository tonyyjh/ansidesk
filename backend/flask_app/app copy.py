...
# ——— Configuración ———
PROXMOX_HOST = "10.144.212.69"
API_TOKEN_ID = "admin@pam!admin"
API_TOKEN_SECRET = "20477125-29d4-4bd1-9e55-88cbc8456f21"
NODE_NAME = "ansidesk"
VERIFY_SSL = False
USERNAME = "root@pam"
PASSWORD = "G@gant0nya1ex"
...
def create_machine():
    try:
        ...
        token_value = "20477125-29d4-4bd1-9e55-88cbc8456f21"
        node = "ansidesk"
...
def get_novnc_url_by_name(user_id, idvm):
    try:
        ...
        novnc_url = f"https://proxmox.ansidesk.cat:8006/?console=kvm&novnc=1&vmid={proxmox_vm_id}&vmname={name}&node={NODE_NAME}"
